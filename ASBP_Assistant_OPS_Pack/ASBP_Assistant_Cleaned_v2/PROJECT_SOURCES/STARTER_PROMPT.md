...
- operating rules and this starter prompt live in Project Sources
...
- terminology lag, tracker formatting lag, repo naming lag, or public-surface lag alone are not mismatches
